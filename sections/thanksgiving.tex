...
% The book closes on a plate of its own bearing the same flair that frames the
% icon. The last page of text runs to the foot, so the flair cannot sit under it
% without stranding the decoration on a page on its own; a deliberate plate reads
% as the end of the book, and costs nothing, since the run pads to whole sheets.
\newpage
\thispagestyle{plain}
\vspace*{\fill}
\ornarule
