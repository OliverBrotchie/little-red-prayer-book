...
% rule, spread so none hangs close to upright, each carrying a vein. The spread
% is what keeps the group reading as leaves rather than as flower petals.
  ...
  \begin{scope}[shift={(#1)}, #2]
    \foreach \a in {-48, -16, 16, 48}{%
      \draw[line width=0.4pt, rotate=\a]
        (0,0) .. controls (0.55mm,0.8mm) and (0.55mm,2.1mm) .. (0,2.9mm)
              .. controls (-0.55mm,2.1mm) and (-0.55mm,0.8mm) .. (0,0);
