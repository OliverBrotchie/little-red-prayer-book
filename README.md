...
entry in the contents, and the icon sits inside a double rule border. The book
ends with the line-and-star flair, printed only when the last page has room for
it, so a decoration never costs a page.
